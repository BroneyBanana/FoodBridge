    ...
    <section class="login-panel" aria-labelledby="login-title">
      ...
      <div class="login-card">
        ...
        <div class="role-tabs" role="tablist" aria-label="Choose account type">
          <button class="role-tab <?php echo $selectedRole === 'donor' ? 'active' : ''; ?>" type="button" role="tab" aria-selected="<?php echo $selectedRole === 'donor' ? 'true' : 'false'; ?>" data-role="donor">Donor</button>
          <button class="role-tab <?php echo $selectedRole === 'receiver' ? 'active' : ''; ?>" type="button" role="tab" aria-selected="<?php echo $selectedRole === 'receiver' ? 'true' : 'false'; ?>" data-role="receiver">Receiver</button>
          <button class="role-tab <?php echo $selectedRole === 'admin' ? 'active' : ''; ?>" type="button" role="tab" aria-selected="<?php echo $selectedRole === 'admin' ? 'true' : 'false'; ?>" data-role="admin">Admin</button>
        </div>

        <form class="login-form" action="login.php" method="post" id="loginForm">
          <input type="hidden" name="role" id="accountRole" value="<?php echo htmlspecialchars($selectedRole, ENT_QUOTES); ?>">

          <label class="form-field" for="email">
            <span>Email</span>
            <input id="email" name="email" type="email" autocomplete="email" value="<?php echo htmlspecialchars($_POST['email'] ?? '', ENT_QUOTES); ?>" required>
          </label>
          ...
          <p class="form-message" role="status" aria-live="polite"><?php echo htmlspecialchars($formError, ENT_QUOTES); ?></p>
