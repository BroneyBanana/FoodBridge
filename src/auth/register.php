    ...
    <form class="register-flow" id="registerForm" action="register.php" method="post">
      ...
      <section class="register-step profile-step" data-step="2" aria-labelledby="profileTitle">
        ...
        <div class="form-card">
          ...
          <label class="field">
            <span>Full name</span>
            <input id="fullName" type="text" name="fullName" placeholder="Your full name" autocomplete="name"
              value="<?php echo htmlspecialchars($posted['fullName'] ?? '', ENT_QUOTES); ?>" required>
          </label>

          <label class="field">
            <span>Email address</span>
            <input type="email" name="email" placeholder="you@email.com" autocomplete="email"
              value="<?php echo htmlspecialchars($posted['email'] ?? '', ENT_QUOTES); ?>" required>
          </label>

          <label class="field">
            <span>Location</span>
            <input type="text" name="profileLocation" placeholder="e.g. Subang Jaya, Selangor"
              autocomplete="street-address"
              value="<?php echo htmlspecialchars($posted['profileLocation'] ?? '', ENT_QUOTES); ?>" required>
          </label>

          <div class="field-grid">
            <label class="field password-wrap">
              <span>Password</span>
              <input id="password" type="password" name="password" placeholder="Min 8 chars" autocomplete="new-password"
            ...
            <label class="field">
              <span>Confirm</span>
              <input id="confirmPassword" type="password" name="confirmPassword" placeholder="Re-type"
      ...
      <section class="register-step otp-step" data-step="3" aria-labelledby="otpTitle">
        <div class="otp-card">
          ...
          <div class="otp-actions" style="margin-top:18px;">
            ...
            <small id="otpTimer"
              style="color:rgba(28,43,30,0.64);font-size:0.9rem;margin-top:12px;display:block;text-align:center;">Expires
              in 5:00</small>
          </div>
        </div>
      </section>
