...
<body>
  ...
  <header class="dashboard-header">
    ...
    <div class="nav-overlay" id="navOverlay">
      <nav class="dashboard-nav">
        <a href="dashboard.html" class="dashboard-nav-item active">Overview</a>
  ...
  <div class="dashboard-wrapper">
    <main class="dashboard-content">
      ...
      <p class="page-subheading">Track your impact, claim food rescue points, and check your active donations status.</p>
      
      <!-- Main content body left entirely blank for user coding -->
