...
$stmt = mysqli_prepare($dbConn, "SELECT COUNT(*) AS total_pickups FROM bookings WHERE receiver_id = ?");
mysqli_stmt_bind_param($stmt, "i", $userId);
mysqli_stmt_execute($stmt);
$pickupCount = mysqli_fetch_assoc(mysqli_stmt_get_result($stmt))['total_pickups'] ?? 0;
mysqli_stmt_close($stmt);
...
<head>
  ...
  <title>Receiver Profile - FoodBridge</title>
...
<body>
  ...
  <div class="dashboard-wrapper">
    <main class="dashboard-content">
      <h1 class="page-heading">Receiver Profile</h1>
        ...
        <div class="profile-grid">
          ...
          <aside class="profile-sidebar" aria-labelledby="sidebarReceiverName">
            <div class="profile-card">
              ...
              <span class="profile-role">Receiver</span>
