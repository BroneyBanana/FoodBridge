...
<body>
  ...
  <div class="dashboard-wrapper"><main class="dashboard-content">
    ...
    <p class="page-subheading">Configure automatic score deductions, verification thresholds, and platform moderation rules.</p>
    <div class="content-body"><div class="container">
      <section class="trust-box" aria-labelledby="rules-title">
        ...
        <form action="trust-rules.php" method="post">
          ...
          <div class="slider-wrapper">
            ...
            <input type="range" min="0" max="100" value="<?php echo $threshold; ?>" id="slider" name="suspension_threshold">
      ...
      <section class="risk-section" aria-labelledby="risk-title">
        ...
        <div class="risk-list">
          ...
          <?php else: foreach ($usersAtRisk as $user): ?>
            <article class="risk-card">
              <div class="risk-user"><div class="risk-avatar"><?php echo escapeHtml(initials($user['full_name'])); ?></div><div>
                <h3><?php echo escapeHtml($user['full_name']); ?></h3>
                <p><?php echo escapeHtml(ucfirst($user['role'])); ?> &middot; <?php echo escapeHtml(ucfirst(str_replace('_', ' ', $user['status']))); ?></p>
              </div></div>
              <div class="risk-meta"><span class="score <?php echo (int) $user['trust_score'] <= 20 ? 'danger' : 'warning'; ?>"><?php echo (int) $user['trust_score']; ?></span></div>
            </article>
